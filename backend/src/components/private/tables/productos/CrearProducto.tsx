...
export const CrearProducto = (): JSX.Element => {
  ...
  const saveCategoria = async (
    ...
    if(content && selectedValues.length > 0 && selectedValues2.length > 0){
      ...
      data.append('tipoprecio', values.tipoprecio)
      ...
      Swal.fire('El producto no tiene descripción o colores', '', 'error')
    ...
    <>
      {loadingComponents
        ...
        >
          ...
          <div className="flex flex-col md:flex-row md:item-center gap-5 mb-10 relative">
             <div className="w-full lg:w-1/4">
              <TitleBriefs titulo="Tipo de precio" />
              <select
                className="border border-black  placeholder-gray-400 outline-none focus:outline-none
                                                        focus:border-black w-full pt-4 pr-4 pb-4 pl-4 mt-2 mr-0 mb-0 ml-0 text-base block bg-secondary-900
                                                        rounded-md transition-all"
              ...
              >
                <option value="">Seleccionar</option>
                <option value="true">Metro x Rollo</option>
                <option value="false">Menor x Mayor</option>
              </select>
              <Errors errors={errors.tipoprecio} touched={touched.tipoprecio} />
            </div>

            {values.tipoprecio === 'true' && (
              <>
                <div className="w-full lg:w-1/3">
            ...
            {values.tipoprecio === 'false' && (
              <>
                <div className="w-full lg:w-1/4">
                  <TitleBriefs titulo="Precio por menor" />
                  <InputsBriefs
                    name="precio1"
                    type="number"
                    value={values.precio1}
                ...
                <div className="w-full lg:w-1/4">
                  <TitleBriefs titulo="Precio por mayor" />
                  <InputsBriefs
                    name="precio2"
                    type="number"
                    value={values.precio2}
