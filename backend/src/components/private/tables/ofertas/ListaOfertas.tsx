...
import { type ofertasValues } from '../../../shared/Interfaces'
...
export const ListaOfertas = () => {
    ...
    const getAllProductos = async (): Promise<void> => {
      ...
      const request = await axios.get(`${Global.url}/allOfertas`, {
        headers: {
  ...
  return (
    ...
    {loadingComponents
      ...
      <div className="bg-secondary-100 p-8 rounded-xl">
        ...
        {filterDate().map((pro: ofertasValues) => (
          <div
          ...
          >
            ...
            <div className="md:text-center md:flex md:justify-center">
              ...
              <img
                src={`${Global.urlImages}/ofertas/${pro.imagen1}`}
                alt=""
