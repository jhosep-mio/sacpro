...
export const EditarOferta = () => {
    ...
    const updateOferta = async (): Promise<void> => {
    ...
    const getOferta = async (): Promise<void> => {
      setLoadingComponents(true)
      const request = await axios.get(`${Global.url}/oneOferta/${id ?? ''}`, {
        headers: {
          Authorization: `Bearer ${
