...
import { distribuidorValues} from '../../../shared/Interfaces'
import { DeleteItems } from '../../../shared/DeleteItems'
import { LoadingSmall } from '../../../shared/LoadingSmall'
const ListarDistribuidor = () => {
    ...
    const getAllProductos = async (): Promise<void> => {
      ...
      const request = await axios.post(`${Global.url}/getDistribuidores`, data, {
        headers: {
    ...
    useEffect(() => {
      setTitle('Listado de distribuidores')
    }, [])
  return (
    <>
    ...
    {loadingComponents
      ...
      <div className="bg-secondary-100 p-8 rounded-xl">
        <div className="hidden md:grid grid-cols-1 md:grid-cols-5 gap-4 mb-10 p-4">
          ...
          <h5 className="md:text-center">Dirección</h5>
          <h5 className="md:text-center">Celular</h5>
          <h5 className="md:text-center">Acciones</h5>
        </div>
        {filterDate().map((pro: distribuidorValues) => (
          <div
...
export default ListarDistribuidor